...
export default function Backtest() {
  ...
  const [requiredIndicators, setRequiredIndicators] = useState<string[]>([]);
  ...
  const [excludeMaBuyAfter, setExcludeMaBuyAfter] = useState(0);
  const [rsiExcludeAfterEnabled, setRsiExcludeAfterEnabled] = useState(false);
  ...
  useEffect(() => {
    if (appSettings && !settingsLoaded) {
      ...
      const endH = parseInt(settingsMap["trading_end_hour"] || "14", 10);
